...
export const VOICES = [
  ...
  { id: 'kokoro-us', engine: 'Kokoro', lang: 'en-US', label: '美式 · 自然', wpm: 146,
    note: '對話節奏,接近真人講話速度' },
  { id: 'kokoro-gb', engine: 'Kokoro', lang: 'en-GB', label: '英式 · 自然', wpm: 146,
    note: '對話節奏,接近真人講話速度' },

  // Deliberate teaching pace, and the only engine with real accent coverage.
  { id: 'edge-us', engine: 'edge-tts', lang: 'en-US', label: '美式 · 清晰', wpm: 114,
    note: '每個字都很清楚,適合剛開始' },
  { id: 'edge-gb', engine: 'edge-tts', lang: 'en-GB', label: '英式 · 清晰', wpm: 114 },
  { id: 'edge-au', engine: 'edge-tts', lang: 'en-AU', label: '澳洲', wpm: 114 },
  { id: 'edge-in', engine: 'edge-tts', lang: 'en-IN', label: '印度', wpm: 114 },
  { id: 'edge-ie', engine: 'edge-tts', lang: 'en-IE', label: '愛爾蘭', wpm: 114 },
  { id: 'edge-za', engine: 'edge-tts', lang: 'en-ZA', label: '南非', wpm: 114 },
  { id: 'edge-ca', engine: 'edge-tts', lang: 'en-CA', label: '加拿大', wpm: 114 },
  { id: 'edge-nz', engine: 'edge-tts', lang: 'en-NZ', label: '紐西蘭', wpm: 114 },

  // One voice, no accent choice — it is a delivery style rather than a region.
  { id: 'chatterbox-us', engine: 'Chatterbox', lang: 'en-US', label: '美式 · 表現力', wpm: 170,
    note: '語氣起伏最大,語速偏快' },
];
